...
if __name__ == '__main__':
    ...
    explorer.push_scanning_results([270])
    explorer.update_current_position((8, 1))
    explorer.push_scanning_results([90, 270, 0])
    explorer.update_current_position((8, 3))
    explorer.path_will_be_explored((8, 1), 270)
    explorer.update_current_position((5, -2))
    explorer.push_scanning_results([90, 120, 150, 190])
    explorer.update_current_position((5, -2))
    explorer.path_will_be_explored((5, -2), 190)
    explorer.update_current_position((5, -2))
    explorer.update_current_position((5, -2))
